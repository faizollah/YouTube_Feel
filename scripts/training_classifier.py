...
def training():
	pos_sen = open("/home/faizollah/mysite/positive.txt", 'r', encoding = 'latin-1').read()
	neg_sen = open("/home/faizollah/mysite/negative.txt", 'r', encoding = 'latin-1').read()
	...
	save_doc = open("/home/faizollah/mysite/classifier.pickle", 'wb')
